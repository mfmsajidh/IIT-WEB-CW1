...
<body>
	...
	<img src="Images/Background/Martian.jpg" width="100%" height="100%">
	<div class="container" style="height: 75%;">
		...
		<br>
		<p><i class="fa fa-male" style="font-size:30px;color:#2a2a57"></i> Matt Damon</p>
		<p><i class="fa fa-female" style="font-size:30px;color:#2a2a57"></i> Jessica Chastain</p>
		<br>
