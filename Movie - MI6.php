...
<body>
	...
	<img src="Images/Background/MI6.jpg" width="100%" height="100%">
	<div class="container" style="height: 75%;">

		<br>
		<br>
		<h1>Mission Impossible 6: Fallout</h1>
		<p><i class="fa fa-info-circle" style="font-size:30px;color:#2a2a57"></i> Available</p>
		<br>
		<p><i class="fa fa-male" style="font-size:30px;color:#2a2a57"></i> Tom Cruise</p>
		<p><i class="fa fa-female" style="font-size:30px;color:#2a2a57"></i> Rebecca Ferguson</p>
		<br>
