...
<body>
	...
	<img src="Images/Background/Hobbit.jpg" width="100%" height="100%">
	<div class="container" style="height: 75%;">

		<br>
		<br>
		<h1>Hobbit: An Unexpected Journey</h1>
		<p><i class="fa fa-info-circle" style="font-size:30px;color:#2a2a57"></i> Available</p>
		<br>
		<p><i class="fa fa-male" style="font-size:30px;color:#2a2a57"></i> Martin Freeman</p>
		<p><i class="fa fa-female" style="font-size:30px;color:#2a2a57"></i> Cate Blanchett</p>
		<br>
